...
// Use
//
//gcc -o ffmpeg_tutorial_modify_03 ffmpeg_tutorial_modify_03.c  -lavformat -lavcodec -lswscale -lavutil -lz -lm `sdl-config --cflags --libs`
//
...
int audio_decode_frame(VideoState *is, uint8_t *audio_buf, int buf_size)
{
  ...
  for(;;) {
    while(is->audio_pkt_size > 0) {
      ...
      len1 = avcodec_decode_audio3(is->audio_st->codec, (int16_t *)audio_buf, &data_size, 
				  pkt);
